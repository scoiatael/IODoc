...
\subsection{Ocena prototypu, uściślenie wymagań na jej podstawie}
	...
	\end{tabular}
\subsection{Poprawianie interfejsu}
	\tabb
...
\subsection{Projekt i wykonanie bazy danych}
	\tabb
		...
		\textbf{Czas trwania:} & 4 dni\\
		\textbf{Opis:} & Etap ten polega na zaprojektowaniu bazy danych, z której będzie korzystał ,,Iron Coach'' oraz na wykonaniu jej.
	\end{tabular}
...
\subsection{Testowanie z udziałem użytkowników, analiza uwag}
	\tabb
		...
		\textbf{Opis:} & Etap ten polega na przetestowaniu aplikacji ,,Iron Coach'' przez przedstawicieli grupy użytkowników, dla których jest budowana, co ma na celu sprawdzenie zgodności tej aplikacji z oczekiwaniami użytkowników.
	\end{tabular}
...
\subsection{Dodanie nowych funkcji}
	\tabb
		...
		\textbf{Czas trwania:} & 7 dni\\
		\textbf{Opis:} & Etap ten ma na celu dodanie do aplikacji ,,Iron Coach'' funkcji, których brak (i potrzebę ich implementacji) stwierdzono np. w testach z użytkownikami.
	\end{tabular}
