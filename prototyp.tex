...
\begin{figure}[b!]
  \includegraphics{Glowny1.png}
  \caption{Ekran główny po pierwszym uruchomieniu}
  \label{G1}
\end{figure}
\begin{figure}[b!]
  \includegraphics{Glowny2.png}
...
\subsubsection{Ekran}
\begin{figure}[b!]
  \includegraphics{Sports1.png}
  \caption{Ekran start po pierwszym uruchomieniu}
  \label{S1}
\end{figure}
\begin{figure}[b!]
  \includegraphics{Sports2.png}
