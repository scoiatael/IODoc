...
% \dicen{pojecie} - definicja
	...
	\dicen{odcinek (ang. \textit{lap})}-- jeden etap (część) całej trasy (np. okrążenie).\\
	\dicen{osiągnięcia (ang. \textit{achievements})}-- nagrody, które użytkownicy mogą uzyskać za osiąganie wyznaczonych celów. System osiągnięć służy do motywacji użytkowników i doprowadzenia do rywalizacji między nimi.\\
